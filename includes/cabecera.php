...
<header class="fixed">
	<header class="header">
		<div  class="div-logo"><img class="logo" src="assets/logo/nuevologo.svg"></div>
		<nav id="nav">
...
<header class="fixed">
	<header class="header">
		...
		<div class="headersesion"> 
			<button onclick=" return mostrarOcultar('session-form')" class="boton boton-iniciarsesion" href="iniciarsesion.php">INICIA SESION</button>
				<div id="session-form">
